...
namespace ChangeManagement.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        private readonly SignInManager<ApplicationUser> _signInManager;
        //Add Role Manager as first step to adding a Role
        ...
        {
            ////Creating the Roles in Utility here
